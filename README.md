...
A full reference for this library is available [here](https://github.com/cdonel707/disney-typescript-sdk/blob/HEAD/./reference.md).
...
try {
    ...
    if (err instanceof DisneyOpensourceError) {
...
```typescript
const { data, rawResponse } = await client.getAllCharacters(...).withRawResponse();
